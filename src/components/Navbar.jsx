...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex md:justify-center justify-between items-center py-7">
      ...
      <ul className="text-gray-500 md:flex hidden list-none flex-row justify-between items-center flex-initial">
        ...
        <li className="text-zap-white font-bold bg-zap-black py-2 px-7 mx-4 rounded-full cursor-pointer hover:bg-[#FAE798]">
          Solutions
        </li>
      </ul>
